...
namespace QuartierLatin.Backend.Application.PortalServices
{
    public class PortalUserAppService : IPortalUserAppService
    {
        ...
        public async Task<int> RegisterAsync(string firstName, string lastName, string phone, string email, string password)
        {
            ...
            return await _portalUserRepository.RegisterAsync(firstName, lastName, phone, email, PasswordToolkit.EncodeSshaPassword(password));
        }
        ...
        {
            return await _portalUserRepository.LoginAsync(email, PasswordToolkit.EncodeSshaPassword(password));
        }
    }
}
